...
<div class="container">
 ...
 <?php endif; ?>
  <form id="employeeform" action="<?php echo e(route('employees_update',$employee->id)); ?>" method="POST" enctype="multipart/form-data">
  ...
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" id="lastname" name="lastname" value="<?php echo e($employee->lastname); ?>" required="">
    </div>
  </div>
  <div class="form-row">
     <div class="col-md-4 mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\project_crm\resources\views/employees/edit.blade.php ENDPATH**/ ?>